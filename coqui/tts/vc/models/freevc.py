...
from coqui.tts.vc.configs.freevc_config import FreeVCConfig
from coqui.tts.vc.models.base_vc import BaseVC
from coqui.tts.vc.modules.freevc.commons import get_padding, init_weights
from coqui.tts.vc.modules.freevc.mel_processing import mel_spectrogram_torch
from coqui.tts.vc.modules.freevc.speaker_encoder.speaker_encoder import SpeakerEncoder as SpeakerEncoderEx
from coqui.tts.vc.modules.freevc.wavlm import get_wavlm
...
class FreeVC(BaseVC):
    ...
    Examples:
        >>> from coqui.tts.vc.configs.freevc_config import FreeVCConfig
        >>> from coqui.tts.vc.models.freevc import FreeVC
        >>> config = FreeVCConfig()
        >>> model = FreeVC(config)
    """
