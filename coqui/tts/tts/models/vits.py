...
from coqui.tts.tts.configs.shared_configs import CharactersConfig
from coqui.tts.tts.datasets.dataset import TTSDataset, _parse_sample
from coqui.tts.tts.layers.glow_tts.duration_predictor import DurationPredictor
from coqui.tts.tts.layers.vits.discriminator import VitsDiscriminator
from coqui.tts.tts.layers.vits.networks import PosteriorEncoder, ResidualCouplingBlocks, TextEncoder
from coqui.tts.tts.layers.vits.stochastic_duration_predictor import StochasticDurationPredictor
from coqui.tts.tts.models.base_tts import BaseTTS
from coqui.tts.tts.utils.fairseq import rehash_fairseq_vits_checkpoint
from coqui.tts.tts.utils.helpers import generate_path, maximum_path, rand_segments, segment, sequence_mask
from coqui.tts.tts.utils.languages import LanguageManager
from coqui.tts.tts.utils.speakers import SpeakerManager
from coqui.tts.tts.utils.synthesis import synthesis
from coqui.tts.tts.utils.text.characters import BaseCharacters, BaseVocabulary, _characters, _pad, _phonemes, _punctuations
from coqui.tts.tts.utils.text.tokenizer import TTSTokenizer
from coqui.tts.tts.utils.visual import plot_alignment
from coqui.tts.utils.io import load_fsspec
from coqui.tts.utils.samplers import BucketBatchSampler
from coqui.tts.vocoder.models.hifigan_generator import HifiganGenerator
from coqui.tts.vocoder.utils.generic_utils import plot_results
...
class Vits(BaseTTS):
    ...
    Examples:
        >>> from coqui.tts.tts.configs.vits_config import VitsConfig
        >>> from coqui.tts.tts.models.vits import Vits
        >>> config = VitsConfig()
        >>> model = Vits(config)
    """
    ...
    def get_criterion(self):
        ...
        `train_step()`"""
        from coqui.tts.tts.layers.losses import (  # pylint: disable=import-outside-toplevel
    ...
    def load_fairseq_checkpoint(
        ...
        from coqui.tts.tts.utils.text.cleaners import basic_cleaners
    ...
    def init_from_config(config: "VitsConfig", samples: Union[List[List], List[Dict]] = None, verbose=True):
        ...
        Args:
            ...
            samples (Union[List[List], List[Dict]]): Training samples to parse speaker ids for training.
                Defaults to None.
        """
        from coqui.tts.utils.audio import AudioProcessor
