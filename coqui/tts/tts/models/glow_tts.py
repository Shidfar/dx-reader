...
from coqui.tts.tts.configs.glow_tts_config import GlowTTSConfig
from coqui.tts.tts.layers.glow_tts.decoder import Decoder
from coqui.tts.tts.layers.glow_tts.encoder import Encoder
...
class GlowTTS(BaseTTS):
    ...
    Examples:
        ...
        >>> from coqui.tts.tts.configs.glow_tts_config import GlowTTSConfig
        >>> from coqui.tts.tts.models.glow_tts import GlowTTS
    ...
    @staticmethod
    def get_criterion():
        from coqui.tts.tts.layers.losses import GlowTTSLoss  # pylint: disable=import-outside-toplevel
