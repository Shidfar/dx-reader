...
from coqui.tts.tts.layers.align_tts.mdn import MDNBlock
from coqui.tts.tts.layers.feed_forward.decoder import Decoder
from coqui.tts.tts.layers.feed_forward.duration_predictor import DurationPredictor
...
from coqui.tts.tts.utils.helpers import generate_path, maximum_path, sequence_mask
from coqui.tts.tts.utils.speakers import SpeakerManager
from coqui.tts.tts.utils.text.tokenizer import TTSTokenizer
from coqui.tts.tts.utils.visual import plot_alignment, plot_spectrogram
...
class AlignTTS(BaseTTS):
    ...
    Examples:
        >>> from coqui.tts.tts.configs.align_tts_config import AlignTTSConfig
    ...
    def get_criterion(self):
        from coqui.tts.tts.layers.losses import AlignTTSLoss  # pylint: disable=import-outside-toplevel
