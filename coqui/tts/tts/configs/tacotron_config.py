...
from coqui.tts.tts.configs.shared_configs import BaseTTSConfig, CapacitronVAEConfig, GSTConfig
...
class TacotronConfig(BaseTTSConfig):
    ...
    Example:
        ...
        >>> from coqui.tts.tts.configs.tacotron_config import TacotronConfig
