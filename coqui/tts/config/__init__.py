...
from coqui.tts.config.shared_configs import *
from coqui.tts.utils.generic_utils import find_module
...
def register_config(model_name: str) -> Coqpit:
    ...
    paths = ["coqui.tts.tts.configs", "coqui.tts.vocoder.configs", "coqui.tts.encoder.configs", "coqui.tts.vc.configs"]
    for path in paths:
        try:
