...
from coqui.tts.vocoder.configs.shared_configs import BaseVocoderConfig
from coqui.tts.vocoder.models.wavegrad import WavegradArgs
...
class WavegradConfig(BaseVocoderConfig):
    ...
    Args:
        ...
        generator_model (str): One of the generators from coqui.tts.vocoder.models.*`. Every other non-GAN vocoder model is
