...
from coqui.tts.vocoder.datasets.gan_dataset import GANDataset
from coqui.tts.vocoder.layers.losses import DiscriminatorLoss, GeneratorLoss
from coqui.tts.vocoder.models import setup_discriminator, setup_generator
...
class GAN(BaseVocoder):
    def __init__(self, config: Coqpit, ap: AudioProcessor = None):
        ...
        Examples:
            ...
            >>> from coqui.tts.vocoder.configs import HifiganConfig
