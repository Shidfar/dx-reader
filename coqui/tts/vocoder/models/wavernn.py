...
from coqui.tts.tts.utils.visual import plot_spectrogram
from coqui.tts.utils.audio import AudioProcessor
from coqui.tts.utils.audio.numpy_transforms import mulaw_decode
from coqui.tts.utils.io import load_fsspec
from coqui.tts.vocoder.datasets.wavernn_dataset import WaveRNNDataset
from coqui.tts.vocoder.layers.losses import WaveRNNLoss
from coqui.tts.vocoder.models.base_vocoder import BaseVocoder
from coqui.tts.vocoder.utils.distribution import sample_from_discretized_mix_logistic, sample_from_gaussian
...
class Wavernn(BaseVocoder):
    def __init__(self, config: Coqpit):
        ...
        Examples:
            >>> from coqui.tts.vocoder.configs import WavernnConfig
