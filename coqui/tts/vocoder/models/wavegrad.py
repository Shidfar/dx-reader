...
from coqui.tts.vocoder.datasets import WaveGradDataset
from coqui.tts.vocoder.layers.wavegrad import Conv1d, DBlock, FiLM, UBlock
...
class Wavegrad(BaseVocoder):
    ...
    Examples:
        ...
        >>> from coqui.tts.vocoder.configs import WavegradConfig
